...
// ./tests/
import ServerTestHelper from '../../../../tests/helpers/ServerTestHelper'
...
describe('/threads endpoint', () => {
  ...
  describe('when GET /threads/{threadId}', () => {
    ...
    it('should respond 200 with valid thread structures (contain valid comments and replies)', async () => {
      ...
      await ThreadsTableHelper.addThread({ id: 'thread-123', owner: dummyUser.id })
      ...
      await ThreadCommentRepliesTableHelper.softDeleteReply('reply-xyz')
  ...
  describe('when PUT /threads/{threadId}/comments/{commentId}/likes', () => {
    ...
    it('should respond 404 status code when the comment is not found ON THE THREAD', async () => {
      ...
      await ThreadsTableHelper.addThread({}) // thread-123
      await ThreadsTableHelper.addThread({ id: 'thread-xyz' })
      await ThreadCommentsTableHelper.addCommentToThread({}) // comment-123 on thread-123
  ...
  describe('when DELETE /threads/{threadId}/comments/{commentId}/replies/{replyId}', () => {
    ...
    it('should respond 404 status code when the comment is not found ON THE THREAD', async () => {
      ...
      await UsersTableHelper.addUser(dummyUser) // user-123
      const accessToken = await ServerTestHelper.login(dummyUser)
    ...
    it('should respond 200 status code', async () => {
      ...
      await ThreadsTableHelper.addThread({}) // thread-123
      await ThreadCommentsTableHelper.addCommentToThread({}) // comment-123 on thread-123
      await ThreadCommentRepliesTableHelper.addReplyToComment({}) // reply-123 on comment-123
